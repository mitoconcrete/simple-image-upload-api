...
# from app.schemas.dto.service_request import (
#     UploadImage,
#     UploadImageServiceRequestDto,
#     UploadServiceRequestDto,
#     UploadSVGServiceRequestDto,
# )
# from app.schemas.dto.service_response import (
#     GetImageServiceResponseDto,
#     ImageDetailResponse,
#     ImageSimpleResponse,
#     UploadImageServiceResponseDto,
#     UploadServiceResponseDto,
#     UploadSVGServiceResponseDto,
# )
...
# def _upload_image(
#     bucket_name: str, save_path: str, image: bytes, label: Optional[str] = None
# ) -> UploadImageServiceResponseDto:
...
#     return UploadImageServiceResponseDto(id=original_id, original_url=original_url, image=image)
...
#     return UploadSVGServiceResponseDto(id=processed_id, proccessed_url=processed_url)
